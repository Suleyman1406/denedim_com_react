...
const Content = styled.h3`
  ...
  border-bottom: ${(props) =>
    props.isSelected ? "3px solid  #f9ca24" : "none"};
  &:hover {
...
const Profile = () => {
  ...
  useEffect(() => {
    ...
    else a = comments.filter((com) => savedCommentsId.includes(com.id));
  ...
  return (
    <Container>
      <Top>
        <TopName>{user.name + " " + user.surname}</TopName>
      </Top>
      <Header>
        <ImageContainer>
