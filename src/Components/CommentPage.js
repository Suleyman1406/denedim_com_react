      ...
      <ContentContainer isLogged={isLogged}>
        <TodayContainer>
          <TodayElement style={{ marginRight: "15px" }}>
            ...
            <TodayPrg>
              {" "}
              IP67 düzeyinde suya dayanıklı Samsung Galaxy A52 telefonla
              tanışın!
            </TodayPrg>
          </TodayElement>
          <TodayElement style={{ marginLeft: "15px" }}>
            ...
            <TodayPrg style={{ fontWeight: "bold", padding: "3px 10px" }}>
              Mini el kuru ve ıslak kablosuz kablosuz elektrik süpürgesi
            </TodayPrg>
            <TodayPrg>
              X Marka Elektrik Süpürgesi boyutu küçük ama çok kullanışlı. Cok az
              yer kaplıyor
            </TodayPrg>
          </TodayElement>
        </TodayContainer>
